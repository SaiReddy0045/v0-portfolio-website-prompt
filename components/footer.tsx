export default function Footer() {
  ...
  return (
    <footer className="border-t border-primary/20 py-8 px-4 sm:px-6 lg:px-8 bg-black/50">
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
          <p className="text-gray-500">© {currentYear} Sai Kumar Reddy. All rights reserved.</p>
